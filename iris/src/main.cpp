...
int main() {
  ...
  DoublePendulum pendulum(100.0f, 100.0f, 10.0f, 10.0f, M_PI / 2.0f,
                          M_PI / 2.0f, 0.05f);
  ...
  while (!WindowShouldClose()) {
    ...
    std::string frameTimeStr = "FPS: " + std::to_string(fps) +
    ...
    ImGui::SliderFloat("Circle Size", &radius, 10.0f, 200.0f);
    ImGui::End();
    rlImGuiEnd();
